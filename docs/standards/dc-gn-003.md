# DC-GN-003: Introduction

!!! info "Document Information"
    **Standard ID**: DC-GN-003  
    **Version**: 1.0  
...
![](../assets/images/dc-gn-003-image-01.png)
...
3. ![](../assets/images/dc-gn-003-image-01.png)Click Site>Double click FP-SITEPLAN> FP-SITEPLAN (Fig: 4 - 1&2)
...
## ![](../assets/images/dc-gn-003-image-01.png)Link the Site Model
...
![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)3. Click ‘By Host View’ (Fig: 8)  

Figure 8: Visibility/Graphic Overrides settings for ATL-DOC-FP-SITE with 'By Host View' display setting selected

![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)4. Basics> Custom
...
![](../assets/images/dc-gn-003-image-01.png)6. Check (Tick) “xcv-basemap.dwg” (Fig 10 - 3)  

Fig 10: RVT Link Display Settings - Import Categories with 'xcv-basemap.dwg' checked

![A map of a city
](../assets/images/dc-gn-003-image-01.png)7. The Site Plan view now shows the linked model   
...
- ![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)Click OK  
...
5. ![A screenshot of a map
](../assets/images/dc-gn-003-image-01.png)  Verify that the GIS Coordinates are set to "ATL\_02"(Fig 14 – 2)
...
](../assets/images/dc-gn-003-image-01.png)Open Floor Plan by double-clicking the floor plan as highlighted in Fig: 15  
...
- Click on the ‘Copy/Monitor’ button (Fig 16 – 2)                                                                                                                                          

3. Select Link:

- Choose ‘Select Link.’ (Fig 16 – 3)
- Select the model containing the required grids and levels
- ![](../assets/images/dc-gn-003-image-01.png)Select and copy the required grids and level
...
- ![](../assets/images/dc-gn-003-image-01.png)Ensure the ‘Multiple’ checkbox is selected if you need to copy multiple elements. (Fig 17 -2)

Fig 17: Copying multiple elements using the Copy/Monitor tool

- ![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)Once all required grids and levels are selected, click the Finish button. (Fig 18)
...
![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)Option 2 - Upload a Workshared Model to Autodesk Docs (Revit Cloud Worksharing)
...
- Click Collaborate tab![](../assets/images/dc-gn-003-image-01.png)Manage Collaboration panel![](../assets/images/dc-gn-003-image-01.png)![](../assets/images/dc-gn-003-image-01.png) (Collaborate).
...
- You can drag files directly into the dialog box or click ‘from your computer’![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)
...
- ![A screenshot of a computer
](../assets/images/dc-gn-003-image-01.png)The project file will now appear in the folder you selected.  
