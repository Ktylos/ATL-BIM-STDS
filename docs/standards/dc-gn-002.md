...
|----------------|-------------|---------|------|
| ATL-STD-XX-DC-GN-002 __(THIS DOCUMENT)__ | P&D BIM Standards. Outlines the information requirements, project workflows, and technical guidelines for BIM implementation. | 2 | Jan 2026 |
| ATL-STD-XX-DC-GN-001 | Information Structure, Naming, and Format Standard. Outlines the format, structure and naming of the information. Includes naming standards for documents and plans as well as rooms, doors, and spaces. | 2 | Jan 2026 |
| ATL-STD-XX-DC-GN-003 | Revit Project Setup with Custom Coordinates. Describe the procedure for initiating a new project utilizing the provided templates. | 2 | Jan 2026 |
...
![A screen shot of a diagram](../assets/images/dc-gn-002-image-01.png) 
...
## 3 BIM DOCUMENTS AND SUPPORT FILES
...
ATL-STD-DOC-Policy&Requirements

BIM Standards

ATL-STD-DOC-BIM\_Standards

Project Setup

ATL-STD-DOC-BIM\_Revit Project Setup

Content > Revit > Families

Revit Templates that contain all discipline specific support files and content

Lookup Tables Includes the support files for conduits and pipes

Borders 22x34 and 30x42 borders and Title sheet drawings

Software Templates > Revit

Revit Templates

Includes the discipline-specific template files for the Architectural, MEP and Structural disciplines

ATL-TP-RVT-A

Shared Parameters Includes the ATL custom Parameters file
...
P&D offers Revit templates designed to ensure consistency in the development of Revit models. These templates include a variety of predefined elements, such as supporting legends, an initial view, a customized project browser, shared parameters, loaded families, view templates, and set parameters for units, fill patterns, line styles, line weights, scales, text, and dimensions, among others.
 ...
 ![A document with text on it](../assets/images/dc-gn-002-image-01.png)
...
[A white rectangular object with black lines](../assets/images/dc-gn-002-image-01.png)

Figure 4 - Contract Border 		       		Figure 5 - Title Sheets           

 

The location of the Title Block families within the Browser in the Revit Template.

![A screenshot of a computer](../assets/images/dc-gn-002-image-01.png)
...
ATL BIM Standard structures project deliverables for better coordination within P&D and their Consultants. The goal is to enhance collaboration and ensure electronic information can be used beyond the initial contract.

Folder Use Descriptions
...
The coordinate system is delineated by a basemap with the “Airport Grid” custom coordinates referred to as ATL\_02. Please adhere to the "New Project Setup" document, utilizing our template and the Concourse file in Revit to acquire these coordinates for your project. To verify their accuracy, export a 3D model and import it into the Civil 3D basemap to confirm the location.

![A screenshot of a computer](../assets/images/dc-gn-002-image-01.png)

Figure 8 - Revit Project Setup with Custom Coordinates Document

## 7 INFORMATION DELIVERY PLAN (IDP)
...
### 7.2 Design Model vs. Construction Model
...
Conduits under 1": not modeled in 3D

Supports, hangers: listed but typically simplified

Wiring: generally schematic only

Mechanical Systems

Hangers, supports, vibration isolators: usually omitted

Duct/pipe insulation: modeled only for key spatial cases

Plumbing Systems

Pipes under 1" (drains/vents): may be excluded

Pipe insulation

Cleanouts/minor accessories: often omitted

Fire Protection

Piping under 1": excluded

System valves/small accessories: omitted

Pipe hangers/seismic bracing: not modeled

## 8 PROJECT COORDIANTION MEETINGS
...
### 8.3 Biweekly Coordination Meetings

__Purpose: __Monitor model progression, identify and resolve coordination issues, and align teams toward shared project milestones.

__Frequency: __Biweekly (or weekly during critical phases)
...
### 8.6 Use of ACC for Meeting Follow-up
...
#### 9.3.1 Design Model Creation Workflow 
...
### 9.4 Working with Links

#### 9.4.1 Linking Revit Files
...
__NOTE: __It is recommended to use the Link CAD Tool rather than the Import CAD Tool to prevent performance issues with AutoCAD entities. Reference Drawings are linked into Floor Plan Views and/or Ceiling Plan Views. 

### 9.5 Shared Parameters
...
![Image of SHared Parameter File](../assets/images/dc-gn-002-image-01.png)
...
![A document with text and images](../assets/images/dc-gn-002-image-01.png)
...
__![A screenshot of a computer](../assets/images/dc-gn-002-image-01.png)__

Figure 12 - Project Information

#### 9.6.2 Project Browser
...
These views ensure coordination across various Discipline Revit Models and are intended solely for coordination purposes. They encompass Floor Plans, Ceiling Plans, 3D Views, and Elevations. The subcategories include EXPORT, MODEL INTEGRITY, and QAQC. These views must not be deleted.

DOCUMENTATION

The views are intended to be incorporated into the contract set.

WORKING

These views are provided solely for working purposes and are not intended for inclusion in the Contract Set. They are temporary and should be removed prior to the final submission.
...
![A screenshot of a test](../assets/images/dc-gn-002-image-01.png)
...
![A close up of a document](../assets/images/dc-gn-002-image-01.png)

Figure 18 - Symbol Legend Library in ATL-Template

#### 9.6.6 Filled Regions 
...
![A close-up of a color chart](../assets/images/dc-gn-002-image-01.png)
...
![A screenshot of a computer screen](../assets/images/dc-gn-002-image-01.png)
...
#### 9.7.1 Inter-discipline Color Scheme
...
#### 9.7.2 Interference Check / Clash Detection
...
__NOTE: __The Clash Detection tool should be used during the design process to coordinate major building elements and systems, facilitating the early identification of interferences.

#### 9.7.3 Single-Discipline Clash Detection
...
#### 9.7.4 Cross-Discipline Clash Detection
...
__Step 4: Submission via ACC Transmittal Workflow: __Upload the finalized ZIP package to the designated Autodesk Construction Cloud (ACC) folder specified in the BEP (Section 11).
...
## Construction Models Creation Workflow 
...
Naming Sections Removed to Separate Doc
